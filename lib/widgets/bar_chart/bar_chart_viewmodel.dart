...
class BarChartViewmodel {
  BarChartViewmodel({required this.screenWidth, required this.screenHeight});
  ...
  double barGap() {
    double width = (7 / 412) * screenWidth;
    return width;
  }
...
canvas.drawPath(path, paint);
  ...
  double getHeight(double figmaHeight) {
    double height = (figmaHeight / 1046) * screenHeight;
    return height;
  }

  double getWidth(double figmaWidth) {
    double width = (figmaWidth / 412) * screenWidth;
    return width;
  }
}
